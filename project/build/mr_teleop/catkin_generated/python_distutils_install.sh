...
echo_and_run cd "/home/dixuan/Document/robotique/project/src/mr_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/dixuan/Document/robotique/project/src/mr_teleop/setup.py" \
     \
    build --build-base "/home/dixuan/Document/robotique/project/build/mr_teleop" \
    install \
    --root="${DESTDIR-/}" \
